...
const MODEL_REVISION = 'play-jester-arrogant-rig-animation-20260902-v1';
const MODEL_URL = new URL(
  `assets/assets/models/textured-glb-comparison/play_jester_v2_rigged_arrogant_web.glb?rev=${MODEL_REVISION}`,
  document.baseURI,
).href;
