...
function findSafeEntranceSpawn(anchor, includeBroom=true) {
  ...
  for (const candidate of candidates) {
    ...
    if (typeof hasLubiakMeshClearance !== 'function' || hasLubiakMeshClearance(candidate, includeBroom)) return candidate;
  }
...
function movePlayerWithCollision(delta, includeBroom=false) {
  ...
  if(!solved.equals(start) && typeof hasLubiakMeshClearance === 'function' && !hasLubiakMeshClearance(solved, includeBroom)) solved=start.clone();
  if(solved.equals(start)) {
    ...
    if(!xTry.equals(start) && typeof hasLubiakMeshClearance === 'function' && !hasLubiakMeshClearance(xTry, includeBroom)) xTry=start.clone();
    ...
    if(!zTry.equals(zStart) && typeof hasLubiakMeshClearance === 'function' && !hasLubiakMeshClearance(zTry, includeBroom)) zTry=zStart.clone();
