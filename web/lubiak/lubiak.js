...
async function installEnvironment() {
  ...
  const candidates = [
    ...
    { url: '/assets/models/textured-glb-comparison/LUBIAK_palace_pbr_repaired_final.glb?v=safe-33492995942-1', label: 'LOADING LUBIAK MASTER', finish: 'ENTER LUBIAK', timeoutMs: 26000 },
  ];
