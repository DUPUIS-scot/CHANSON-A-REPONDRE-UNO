...
async function installEnvironment() {
  ...
  const candidates = [
    ...
    { url: '/assets/models/textured-glb-comparison/LUBIAK_master_optimized_4_ELEMENT_PBR_WEB_OPTIMIZED.glb?v=20260901-palace-pbr-repaired-v1', label: 'LOADING LUBIAK MASTER', finish: 'ENTER LUBIAK', timeoutMs: 26000 },
  ];
