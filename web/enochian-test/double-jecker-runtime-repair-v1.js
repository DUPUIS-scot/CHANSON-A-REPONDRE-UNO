...
function install(host){
  try{
    ...
    const ensureStems=()=>{if(['v3','v4'].includes(d.documentElement.dataset.stemFourChannel))return true;if(window.installEnochianStemFourChannelV1)return !!window.installEnochianStemFourChannelV1(host);if(stemPending)return false;stemPending=true;load('stem-four-channel-v3','/enochian-test/stem-four-channel-ui-v1.js?v=20260906-v7',()=>{stemPending=false;window.installEnochianStemFourChannelV1?.(host)});return false};
