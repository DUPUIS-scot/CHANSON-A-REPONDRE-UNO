...
function install(frame){
 ...
 if(d.documentElement.dataset.lineInLiveWaveform==='v3')return true;
 ...
 d.documentElement.dataset.lineInLiveWaveform='v3';
 ...
 const detect=()=>{const s=w.__enochLineIn?.getStream?.()||w.__enochLineIn?.stream;if(s?.active)attach(s)};
 ...
 drawIdle();
 w.__enochLineInLiveWaveform={version:'v3',attach,stop:detach,getStream:()=>stream};
 return true;
}
