(()=>{'use strict';
const VERSION='v13-terrain-controls';
function install(frame){
 try{
  ...
  if(d.documentElement.dataset.twoMixMasterLayout==='v13'&&d.documentElement.dataset.twoMixActivationAuthority===VERSION)return true;
  ...
  const master=findMaster();if(master)master.dataset.masterDeck='1';const wave=d.querySelector('.wave');if(wave&&toggle.parentElement!==wave)wave.appendChild(toggle)
  ...
  style.textContent='#twoMixToggle.two-mix-master-anchor{position:absolute!important;right:12px!important;top:12px!important;bottom:auto!important;left:auto!important;z-index:16!important;display:block!important;visibility:visible!important;opacity:1!important;pointer-events:auto!important;touch-action:manipulation!important;cursor:pointer!important;isolation:isolate!important}';
  ...
  sync();
  d.documentElement.dataset.twoMixMasterAnchor='v1';d.documentElement.dataset.twoMixMasterLayout='v13';d.documentElement.dataset.twoMixActivationAuthority=VERSION;
