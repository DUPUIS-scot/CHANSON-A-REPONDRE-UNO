...
async function install(frame){
 try{
  ...
  const unifiedReady=await ensureScript('/enochian-test/analyser-signal-unified-v1.js?v=20260908-live-input-sculpt-v7',()=>typeof window.installEnochianAnalyserSignalUnifiedV1==='function');
  ...
  const sculptReady=await ensureScript('/enochian-test/analyser-multipoint-sculpt-v2.js?v=20260908-terrain-live-sculpt-v7',()=>typeof window.installEnochianMultipointSculptV2==='function');
