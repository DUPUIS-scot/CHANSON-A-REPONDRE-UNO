...
async function install(frame){
 try{
  ...
  const sculptReady=await ensureScript('/enochian-test/analyser-multipoint-sculpt-v2.js?v=20260906-colour-sculpt-v7',()=>typeof window.installEnochianMultipointSculptV2==='function');
