...
const installEnvironment = `async function installEnvironment() {
  ...
  const modules = [
    { name: 'FREAK STREET', url: '${assetBase}freak%20street.glb?v=20260903-modular-v2', position: [0, 12.114883422851562, 34], rotation: null, scale: [72, 72, 72] },
    { name: 'AVENUE', url: '${assetBase}avenue.glb?v=20260903-modular-v2', position: [11.479494094848633, 12.264254570007324, 49.055965423583984], rotation: [0, 0.4113151431083679, 0, 0.9114933013916016], scale: [71.86261749267578, 71.86260223388672, 71.86261749267578] },
    { name: 'ROOF TOP', url: '${assetBase}roof%20top.glb?v=20260903-modular-v2', position: [-9.29807186126709, 22.525930404663086, 33.840213775634766], rotation: [-0.12447847425937653, -0.14730167388916016, -0.028115851804614067, 0.9808245897293091], scale: [28.742916107177734, 28.7429141998291, 28.742918014526367] },
    { name: 'PALACE', url: '${assetBase}palace.glb?v=20260903-modular-v2', position: [0, 11.905579566955566, -18], rotation: null, scale: [77.90990447998047, 77.90990447998047, 77.90990447998047] },
    { name: 'CIRCUS', url: '${assetBase}circus.glb?v=20260903-modular-v2', position: [0, 7.115546226501465, -17], rotation: [0, -0.4972151815891266, 0, 0.8676272630691528], scale: [25.0000057220459, 25, 25.0000057220459] },
    { name: 'DISTRICT 0', url: '${assetBase}district.glb?v=20260903-modular-v2', position: [-24.26102638244629, 8.422406196594238, 29.6292724609375], rotation: [0.07996269315481186, -0.9552930593490601, 0.28146034479141235, 0.04244136065244675], scale: [9.534232139587402, 9.534231185913086, 9.53423023223877] },
    { name: 'CARD ROOM', url: '${assetBase}card%20room.glb?v=20260903-modular-v2', position: [5.9719696044921875, 6.680505275726318, 29.453205108642578], rotation: [0.0668065994977951, 0.7124782204627991, 0.07561159133911133, 0.6944023966789246], scale: [11.452020645141602, 11.452018737792969, 11.452022552490234] },
    { name: 'DRAGON LAIR', url: '${assetBase}dragon%20lair.glb?v=20260903-modular-v2', position: [-21.879623413085938, 4.855525016784668, -53.868255615234375], rotation: null, scale: [17.452329635620117, 17.452329635620117, 17.452329635620117] },
  ];
...
for (const file of ['freak%20street.glb', 'avenue.glb', 'roof%20top.glb', 'palace.glb', 'circus.glb', 'district.glb', 'card%20room.glb', 'dragon%20lair.glb']) {
  if (!js.includes(`${assetBase}${file}?v=20260903-modular-v2`)) throw new Error(`Missing modular asset: ${file}`);
}
