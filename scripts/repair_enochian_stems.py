...
for marker in ['two-mix-space-c-v1.js?v=20260828-v1','installEnochianTwoMixSpaceCV1',"twoMixSpaceC==='v1'"]:
 if marker not in singleton: raise SystemExit(f'2MIX Space C loader missing: {marker}')
...
print('Enochian runtime verified: 2MIX v10 signal memory plus Space C sculpt authority, 2J MIX/STEM/JOG v6, and STEMS/SIGNAL/PLAYBACK authorities remain intact.')
