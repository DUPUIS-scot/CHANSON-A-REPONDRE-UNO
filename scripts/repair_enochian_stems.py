...
for marker in ["twoMixMasterLayout==='v6'",'twoMixHelpToggle','UNO OPENS 2MIX',"helpButton.addEventListener('click',toggleGuide)","__enochTwoMixMasterAnchor={version:'v6'"]:
...
print('Enochian runtime verified: Terminal Viewport Layout Contract v1 freezes fixed owners, permits only registered floatables, preserves 2MIX launcher/help, STEMS, SIGNAL and PLAYBACK authorities.')
