...
checks = {
    ...
    "livestream signal authority replaces the previous runtime": "root.dataset.signalSourceUnified='v6'" in signal_source,
    ...
    "livestream authority is marked only after installation": "root.dataset.signalSourceUnified='v6';w.addEventListener" in signal_source,
