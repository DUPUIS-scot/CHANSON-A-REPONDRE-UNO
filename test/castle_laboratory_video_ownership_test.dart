...
void main() {
  test('laboratory video has one owner and binds the canonical mirrors', () {
    ...
    expect(bridge, contains("const VERSION = 'v80'"));
    ...
    expect(bridge, contains("expectedNames: ['VideoScreen_Left', 'VideoScreen_Right']"));
    ...
    expect(bridge, contains("bureauVideoPlayback = 'paused-v80'"));
